...
/** Tests for {@link HttpRecordingServerConfig}. */
@RunWith(JUnit4.class)
public final class HttpRecordingServerConfigTest {

  @Test
  public void fromRawData_always_createsExpectedConfigObject() {
    HttpRecordingServerConfig config =
  ...
  public void fromRawData_whenNoWorkerPoolSize_createsExpectedConfigObject() {
    HttpRecordingServerConfig config =
        HttpRecordingServerConfig.fromRawData(ImmutableMap.of("port", 80));
  ...
  public void fromRawData_whenMissingConfigKey_throws() {
    assertThrows(
        ...
        () -> HttpRecordingServerConfig.fromRawData(ImmutableMap.of("k", "v")));
  }
  ...
  public void fromRawData_whenInvalidType_throws() {
    assertThrows(
        ...
        () -> HttpRecordingServerConfig.fromRawData(ImmutableMap.of("port", "abc")));
  }
}
